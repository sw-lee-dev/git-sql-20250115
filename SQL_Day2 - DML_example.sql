...
-- [AAA, 국어, 1, null]
-- [AAB, 수학, 2, null]
INSERT INTO class (class_code, name, class_room)
VALUES ('AAA', '국어', 1);
INSERT INTO class (class_code, name, class_room)
VALUES ('AAB', '수학', 2);
...
-- 5. 수업 코드가 'AAA'인 수업에 대해 담당 교사를 '2000010102'로 지정 >> 변경작업
UPDATE class SET charge_teacher = '2000010102' WHERE class_code = 'AAA';

-- 6. 직책이 아직 정해지지 않은 교사에 대해서 직책을 '교생'으로 지정 >> 변경작업
UPDATE teacher SET position = '교생' WHERE position IS NULL;

-- 7. 교실의 좌석수가 25개 이상인 교실을 조회 (교실 번호와 좌석수만 표시)
