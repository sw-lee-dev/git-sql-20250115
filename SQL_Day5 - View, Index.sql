...
-- 인덱스 (Index) : 테이블에서 원하는 컬럼을 빠르게 조회하기 위해 사용하는 구조, 실무에 굉장히 많이 사용!
-- 장점 : 조회 속도 및 성능 향상 / 단점 : 저장공간 증가, 관리의 어려움, 적절한 인덱스를 사용하지 못하면 오히려 성능 저하
...
-- VIEW는 물리적인 저장 공간이 존재하지 않기 때문에 INSERT, UPDATE, DELETE 및 INDEX 생성이 불가능
...
GRANT SELECT ON school.teacher_summary TO 사용자@호스트명; -- 뷰를 사용해서 teacher에 대한 개인정보를 사용자가 못보게 하는 법
